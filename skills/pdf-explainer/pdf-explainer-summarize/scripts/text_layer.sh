...
#
# This is the opt-in text-layer path of pdf-explainer: for a purchased/born-digital
...
# OCR reading — and needs only poppler, which pdf-explainer already requires. It is

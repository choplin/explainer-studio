#!/usr/bin/env python3
"""Harvest figure/chart crops from a MinerU parse into the pdf-explainer figure
contract. Unlike paper-explainer's converter, this does NOT rebuild the body text
(pdf-explainer's visual workers do that) and does NOT crop tables/console output
...
Design choices that differ from paper-explainer (books, not papers):

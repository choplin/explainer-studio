...
The `pdf-explainer-summarize` skill splits a large PDF into chunks and applies this procedure once per chunk, in parallel. It is not for direct user requests and is not invoked proactively.

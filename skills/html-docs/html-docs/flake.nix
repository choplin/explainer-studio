{
  description = "html-docs runtime: pandoc. Renders semantic Markdown (Markdown + fenced divs) into an html-docs page via a template + Lua filter. pandoc is the only dependency; nix supplies it so the generator works with no host setup.";

---
title: Tier 2 components — explainer-html-docs
...
Also engine-free and offline, for a **multi-page reading site** (a landing index plus report pages, as pdf-explainer / paper-explainer generate). It adds two runtime aids on top of `base.js`, and hardcodes no document-type vocabulary.

...
def base_css_source():
    # The shared base design system, owned by the sibling html-docs
    # skill (skills install as flat siblings under the skills root):
    # <root>/reading-site-library-base/scripts/library.py
    #   -> <root>/html-docs/assets/base.css
    return (
...
def base_js_source():
    ...
    # owned by the sibling html-docs skill:
    # <root>/reading-site-library-base/scripts/library.py
    #   -> <root>/html-docs/assets/base.js
    return (
        Path(__file__).resolve().parents[2]
        / "html-docs"
        / "assets"
...
def reading_nav_css_source():
    # The reading-nav widget chrome, owned by the sibling html-docs
    # skill as an opt-in component (the card filter / page-nav styling):
    # <root>/reading-site-library-base/scripts/library.py
    #   -> <root>/html-docs/assets/components/reading-nav/reading-nav.css
    return (
        Path(__file__).resolve().parents[2]
        / "html-docs"
        / "assets"
...
def reading_nav_js_source():
    ...
    # and this library index. Owned by html-docs as an opt-in component:
    #   -> <root>/html-docs/assets/components/reading-nav/reading-nav.js
    return (
        Path(__file__).resolve().parents[2]
        / "html-docs"
        / "assets"
...
def write_public_scaffold(meta):
    ...
    if base.exists():
        ...
        # Fallback: minimal readable stylesheet if html-docs is not

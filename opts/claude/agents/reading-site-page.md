...
Apply the `reading-site-page` skill and follow its procedure end-to-end: read the one source
...
The restructuring rules and class catalog live in the `reading-site-page` skill — do not

...
Apply the `paper-explainer-consistency-sweep` skill and follow its procedure end-to-end: read every
...
The check criteria and the findings format live in the `paper-explainer-consistency-sweep` skill — do
